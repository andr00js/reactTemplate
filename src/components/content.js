export default function Content () { return (
    <div className = 'content'>
        <p>
            ...
            <br></br>
            <br></br>
            Enjoy this minimalist React template.
            <br></br>
            <br></br>
            ...
            <br></br>
            <br></br>
            There are two style sheets included. app.css should hold general styles, while components.css should hold styles for particular components.
            <br></br>
            <br></br>
            Created by andr00js at github.com/andr00js
        </p>
    </div>
)
}